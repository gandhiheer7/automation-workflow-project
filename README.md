...
## Features
- Automated execution of multi-step workflows.  
- Integration of different services into one pipeline.  
- Error-handling and notifications built in.  
- Scalable and reusable for multiple use-cases.  

## Tech Stack
- **n8n** (Workflow automation tool)  
- **JavaScript basics** (workflow logic)  
- **APIs / Webhooks** (service connections)  
...
## Project Assets
All related files (video demo, certificate) are available in this Drive folder:  
Google Drive Folder (https://drive.google.com/drive/folders/1-fieIztw89l-CNGoo2BiGtLCwrJz2SGl?usp=drive_link)
